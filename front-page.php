<?php get_header(); ?>
  <div class="container-fluid">
    ...
    <div class="row row-margin">
      ...
      <div class="col-sm-12 order-md-1 col-md-6 landing-text padding-left row-mobile">
        <div class="logo"><img src="https://danielgotz.nl/wordpress/wp-content/uploads/2019/05/Daniel-jeremy-logo_V02.svg" alt="logo"></div>
        <div class="content">
  ...
  <hr id="about">
  <div class="container-fluid padding" id="test">
    <div class="row about ">
      <!--        <div class="col-md-1 offset"></div>-->
      <div class="col-md-12 col-lg-6">
        <div class="about-image mobile-portrait"> <img src="https://danielgotz.nl/wordpress/wp-content/uploads/2019/05/daniel_jeremy.jpg" alt="logo"></div>
      </div>
      <div class="col-md-12 col-lg-6 about-text content">
        ...
        <div class="bottom-button2 margin-bottom">
          <a href="https://danielgotz.nl/wordpress/contact/">
            <button class="button3 content ">Hire me</button>
          </a>
        </div>
      </div>
    </div>
